...
def main(args):
    ...
    grid = torchvision.utils.make_grid(imgs[::1], nrow=20, normalize=True, scale_each=True)
    print(grid.shape)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--distilled_dataset', type=str, default='/home/ssd7T/ztl_ftd/img_syn_57.pt')
    ...
    '''
sudo CUDA_VISIBLE_DEVICES=3 python /home/wangkai/ztl_project/difussion-dd/FTD-distillation-main/vis.py \
--dataset=CIFAR10 \
...
CUDA_VISIBLE_DEVICES=3 python vis.py \
--dataset=CIFAR10 \
--data_path=/home/ssd7T/ZTL_gcond/data_cv \
--zca \

/home/wangkai/ztl_project/difussion-dd/FTD-distillation-main/vis.py
