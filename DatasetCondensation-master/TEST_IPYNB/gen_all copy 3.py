...
parser.add_argument('--num_exp', type=int, default=20, help='the number of experiments')
...
for exp in range(args.num_exp):
    ...
    torch.save(pairs_real, f'/home/ssd7T/ztl_dm/pairs_real_{exp}.pt')
    torch.save(indexs_real, f'/home/ssd7T/ztl_dm/indexs_real_{exp}.pt')
    ...
    for it in range(args.Iteration+1):
        ...
        if it == args.Iteration: # only record the final results
            ...
            torch.save(image_syn.detach().cpu(), f'/home/ssd7T/ztl_dm/img_syn_{exp}.pt')
            torch.save(label_syn.detach().cpu(), f'/home/ssd7T/ztl_dm/label_syn_{exp}.pt')
