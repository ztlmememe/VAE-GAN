...
def main(args):
    ...
    for exp in range(args.exps):
        ...
        # torch.save(pairs_real, f'/home/ssd7T/ztl_ftd/pairs_real_{exp}.pt')
        torch.save(indexs_real, f'/home/ssd7T/ztl_ftd/indexs_real_{exp}.pt')
        ...
        for it in range(0, args.Iteration+1):
            ...
            if it in eval_it_pool and (save_this_it or it % 1000 == 0):
                with torch.no_grad():
                    ...
                    if save_this_it:
                        ...
                        torch.save(image_save.cpu(), f'/home/ssd7T/ztl_ftd/img_syn_{exp}.pt')
                        torch.save(label_syn.cpu(), f'/home/ssd7T/ztl_ftd/label_syn_{exp}.pt')
            ...
            if it in eval_it_pool and (save_this_it or it % 1000 == 0):
                with torch.no_grad():
                    ...
                    ema_save_dir = os.path.join(".", "ema_logged_files", args.dataset)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exps', type=int, default=50, help='dataset')
    parser.add_argument('--begain', type=int, default=0, help='dataset')
